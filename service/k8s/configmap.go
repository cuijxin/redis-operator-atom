...
// CreateConfigMap 创建一个ConfigMap对象.
...
// UpdateConfigMap 更新一个ConfigMap对象.
...
// CreateOrUpdateConfigMap 创建或者更新一个ConfigMap对象.
func (p *ConfigMapService) CreateOrUpdateConfigMap(namespace string, configMap *corev1.ConfigMap) error {
	...
	// namespace is our spec(https://github.com/kubernetes/community/blob/master/contributors/devel/api-conventions.md#concurrency-contol-and-consistency)
	// we will replace the current namespace state.
	configMap.ResourceVersion = storedConfigMap.ResourceVersion
	return p.UpdateConfigMap(namespace, configMap)
}

// DeleteConfigMap 删除一个ConfigMap对象.
...
// ListConfigMaps 获取ConfigMap对象列表.
