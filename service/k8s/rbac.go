...
// GetRoleBinding 获取RoleBinding对象.
...
// UpdateRole 更新Role对象.
func (r *RBACService) UpdateRole(namespace string, role *rbacv1.Role) error {
	_, err := r.kubeClient.RbacV1().Roles(namespace).Update(role)
	if err != nil {
		return err
	}
...
// CreateOrUpdateRole 创建并更新Role对象.
...
// DeleteRoleBinding 删除RoleBinding对象.
...
// CreateRoleBinding 创建RoleBinding对象.
