...
func (c *FakeRedisFailovers) Get(name string, options v1.GetOptions) (result *redisfailoverv1.RedisFailover, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedisFailovers) List(opts v1.ListOptions) (result *redisfailoverv1.RedisFailoverList, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedisFailovers) Create(redisFailover *redisfailoverv1.RedisFailover) (result *redisfailoverv1.RedisFailover, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedisFailovers) Update(redisFailover *redisfailoverv1.RedisFailover) (result *redisfailoverv1.RedisFailover, err error) {
	obj, err := c.Fake.
...
func (c *FakeRedisFailovers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *redisfailoverv1.RedisFailover, err error) {
	obj, err := c.Fake.
