...
import (
	...
	scheme "redis-operator-atom/client/k8s/clientset/versioned/scheme"
	"time"
...
type RedisFailoverInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.RedisFailover, error)
	List(opts metav1.ListOptions) (*v1.RedisFailoverList, error)
...
func (c *redisFailovers) Get(name string, options metav1.GetOptions) (result *v1.RedisFailover, err error) {
...
func (c *redisFailovers) List(opts metav1.ListOptions) (result *v1.RedisFailoverList, err error) {
...
func (c *redisFailovers) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *redisFailovers) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *redisFailovers) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
